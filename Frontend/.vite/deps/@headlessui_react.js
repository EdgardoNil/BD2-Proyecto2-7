...
function $3ef42575df84b30b$export$9d1611c77c2fe928(...args) {
  ...
  for (let i13 = 1; i13 < args.length; i13++) {
    ...
    for (let key in props) {
      ...
      90) result[key] = (0, $ff5963eb1fccf552$export$e08e3b67e392101e)(a15, b7);
      else if ((key === "className" || key === "UNSAFE_className") && typeof a15 === "string" && typeof b7 === "string") result[key] = (0, clsx_default)(a15, b7);
      else if (key === "id" && a15 && b7) result.id = (0, $bdb11010cef70236$export$cd8c9cb68f842629)(a15, b7);
      else result[key] = b7 !== void 0 ? b7 : a15;
    }
  }
  return result;
}
...
function $f6c31cce2adf654f$var$areRectanglesOverlapping(a15, b7) {
  if (a15.left > b7.right || b7.left > a15.right) return false;
  if (a15.top > b7.bottom || b7.top > a15.bottom) return false;
  return true;
}
...
var r = (t14, e7, n13) => (d(t14, typeof e7 != "symbol" ? e7 + "" : e7, n13), n13);
var o = class {
  constructor() {
...
function o2() {
  let n13 = [], r14 = { addEventListener(e7, t14, s16, a15) {
    return e7.addEventListener(t14, s16, a15), r14.add(() => e7.removeEventListener(t14, s16, a15));
  }, requestAnimationFrame(...e7) {
    let t14 = requestAnimationFrame(...e7);
    return r14.add(() => cancelAnimationFrame(t14));
  }, nextFrame(...e7) {
    return r14.requestAnimationFrame(() => r14.requestAnimationFrame(...e7));
  }, setTimeout(...e7) {
    let t14 = setTimeout(...e7);
    return r14.add(() => clearTimeout(t14));
  }, microTask(...e7) {
    ...
    return n13.includes(e7) || n13.push(e7), () => {
      ...
      if (t14 >= 0) for (let s16 of n13.splice(t14, 1)) s16();
    };
  }, dispose() {
...
function w({ disabled: e7 = false } = {}) {
  let t14 = (0, import_react40.useRef)(null), [n13, l16] = (0, import_react40.useState)(false), r14 = p(), o18 = o4(() => {
    t14.current = null, l16(false), r14.dispose();
  }), f20 = o4((s16) => {
    if (r14.dispose(), t14.current === null) {
      t14.current = s16.currentTarget, l16(true);
      {
        let i13 = u(s16.currentTarget);
        r14.addEventListener(i13, "pointerup", o18, false), r14.addEventListener(i13, "pointermove", (c13) => {
          if (t14.current) {
            let p8 = E(c13);
            l16(P(p8, t14.current.getBoundingClientRect()));
          }
        }, false), r14.addEventListener(i13, "pointercancel", o18, false);
      }
    }
  });
...
function t3(...r14) {
  return Array.from(new Set(r14.flatMap((n13) => typeof n13 == "string" ? n13.split(" ") : []))).filter(Boolean).join(" ");
}

// node_modules/@headlessui/react/dist/utils/match.js
function u2(r14, n13, ...a15) {
  if (r14 in n13) {
    let e7 = n13[r14];
    return typeof e7 == "function" ? e7(...a15) : e7;
  }
  let t14 = new Error(`Tried to handle "${r14}" but there is no handler defined. Only defined handlers are: ${Object.keys(n13).map((e7) => `"${e7}"`).join(", ")}.`);
...
function H({ ourProps: r14, theirProps: n13, slot: e7, defaultTag: a15, features: s16, visible: t14 = true, name: l16, mergeRefs: i13 }) {
  i13 = i13 != null ? i13 : A;
  let o18 = N(n13, r14);
  if (t14) return b(o18, e7, a15, l16, i13);
  let y9 = s16 != null ? s16 : 0;
  if (y9 & 2) {
    let { static: f20 = false, ...u17 } = o18;
    if (f20) return b(u17, e7, a15, l16, i13);
  }
  if (y9 & 1) {
...
function b(r14, n13 = {}, e7, a15, s16) {
  let { as: t14 = e7, children: l16, refName: i13 = "ref", ...o18 } = h(r14, ["unmount", "static"]), y9 = r14.ref !== void 0 ? { [i13]: r14.ref } : {}, f20 = typeof l16 == "function" ? l16(n13) : l16;
  ...
  if (n13) {
    let d16 = false, p8 = [];
    for (let [c13, T12] of Object.entries(n13)) typeof T12 == "boolean" && (d16 = true), T12 === true && p8.push(c13.replace(/([A-Z])/g, (g8) => `-${g8.toLowerCase()}`));
    if (d16) {
      u17["data-headlessui-state"] = p8.join(" ");
      for (let c13 of p8) u17[`data-${c13}`] = "";
    }
  }
  if (t14 === import_react42.Fragment && (Object.keys(m2(o18)).length > 0 || Object.keys(m2(u17)).length > 0)) if (!(0, import_react42.isValidElement)(f20) || Array.isArray(f20) && f20.length > 1) {
    if (Object.keys(m2(o18)).length > 0) throw new Error(['Passing props on "Fragment"!', "", `The current component <${a15} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(m2(o18)).concat(Object.keys(m2(u17))).map((d16) => `  - ${d16}`).join(`
...
`));
    ...
    for (let F6 in u17) F6 in g8 && delete u17[F6];
...
function U() {
  let r14 = (0, import_react42.useRef)([]), n13 = (0, import_react42.useCallback)((e7) => {
    for (let a15 of r14.current) a15 != null && (typeof a15 == "function" ? a15(e7) : a15.current = e7);
  }, []);
  return (...e7) => {
    if (!e7.every((a15) => a15 == null)) return r14.current = e7, n13;
  };
}
function A(...r14) {
  return r14.every((n13) => n13 == null) ? void 0 : (n13) => {
    for (let e7 of r14) e7 != null && (typeof e7 == "function" ? e7(n13) : e7.current = n13);
  };
}
function N(...r14) {
  var a15;
  if (r14.length === 0) return {};
  if (r14.length === 1) return r14[0];
  let n13 = {}, e7 = {};
  for (let s16 of r14) for (let t14 in s16) t14.startsWith("on") && typeof s16[t14] == "function" ? ((a15 = e7[t14]) != null || (e7[t14] = []), e7[t14].push(s16[t14])) : n13[t14] = s16[t14];
  if (n13.disabled || n13["aria-disabled"]) for (let s16 in e7) /^(on(?:Click|Pointer|Mouse|Key)(?:Down|Up|Press)?)$/.test(s16) && (e7[s16] = [(t14) => {
    var l16;
    return (l16 = t14 == null ? void 0 : t14.preventDefault) == null ? void 0 : l16.call(t14);
  }]);
  for (let s16 in e7) Object.assign(n13, { [s16](t14, ...l16) {
    let i13 = e7[s16];
    for (let o18 of i13) {
...
function D(...r14) {
  ...
  let n13 = {}, e7 = {};
  for (let s16 of r14) for (let t14 in s16) t14.startsWith("on") && typeof s16[t14] == "function" ? ((a15 = e7[t14]) != null || (e7[t14] = []), e7[t14].push(s16[t14])) : n13[t14] = s16[t14];
  for (let s16 in e7) Object.assign(n13, { [s16](...t14) {
    let l16 = e7[s16];
    for (let i13 of l16) i13 == null || i13(...t14);
  } });
  return n13;
}
function I(r14) {
  var n13;
  return Object.assign((0, import_react42.forwardRef)(r14), { displayName: (n13 = r14.displayName) != null ? n13 : r14.name });
}
function m2(r14) {
  let n13 = Object.assign({}, r14);
  for (let e7 in n13) n13[e7] === void 0 && delete n13[e7];
  return n13;
}
function h(r14, n13 = []) {
  let e7 = Object.assign({}, r14);
  for (let a15 of n13) a15 in e7 && delete e7[a15];
  return e7;
}
...
function T(l16, r14, c13) {
  ...
  return e7 && !t14.current && !u17.current ? (u17.current = true, t14.current = e7, console.error("A component is changing from uncontrolled to controlled. This may be caused by the value changing from undefined to a defined value, which should not happen.")) : !e7 && t14.current && !d16.current && (d16.current = true, t14.current = e7, console.error("A component is changing from controlled to uncontrolled. This may be caused by the value changing from a defined value to undefined, which should not happen.")), [e7 ? l16 : i13, o4((n13) => (e7 || s16(n13), r14 == null ? void 0 : r14(n13)))];
}
...
function e2(i13 = {}, s16 = null, t14 = []) {
  for (let [r14, n13] of Object.entries(i13)) o6(t14, f3(s16, r14), n13);
  return t14;
}
function f3(i13, s16) {
...
function o6(i13, s16, t14) {
  if (Array.isArray(t14)) for (let [r14, n13] of t14.entries()) o6(i13, f3(s16, r14.toString()), n13);
  else t14 instanceof Date ? i13.push([s16, t14.toISOString()]) : typeof t14 == "boolean" ? i13.push([s16, t14 ? "1" : "0"]) : typeof t14 == "string" ? i13.push([s16, t14]) : typeof t14 == "number" ? i13.push([s16, `${t14}`]) : t14 == null ? i13.push([s16, ""]) : e2(t14, s16, i13);
}
function p2(i13) {
  var t14, r14;
  let s16 = (t14 = i13 == null ? void 0 : i13.form) != null ? t14 : i13.closest("form");
  if (s16) {
    for (let n13 of s16.elements) if (n13 !== i13 && (n13.tagName === "INPUT" && n13.type === "submit" || n13.tagName === "BUTTON" && n13.type === "submit" || n13.nodeName === "INPUT" && n13.type === "image")) {
      n13.click();
      return;
    }
...
function l3(t14, r14) {
  var n13;
  let { features: d16 = 1, ...e7 } = t14, o18 = { ref: r14, "aria-hidden": (d16 & 2) === 2 ? true : (n13 = e7["aria-hidden"]) != null ? n13 : void 0, hidden: (d16 & 4) === 4 ? true : void 0, style: { position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(d16 & 4) === 4 && (d16 & 2) !== 2 && { display: "none" } } };
...
function W(t14) {
  let [e7, r14] = (0, import_react47.useState)(null);
  return import_react47.default.createElement(f4.Provider, { value: { target: e7 } }, t14.children, import_react47.default.createElement(T2, { features: s4.Hidden, ref: r14 }));
}
function c2({ children: t14 }) {
  let e7 = (0, import_react47.useContext)(f4);
  if (!e7) return import_react47.default.createElement(import_react47.default.Fragment, null, t14);
  let { target: r14 } = e7;
  return r14 ? (0, import_react_dom.createPortal)(import_react47.default.createElement(import_react47.default.Fragment, null, t14), r14) : null;
}
function j2({ data: t14, form: e7, disabled: r14, onReset: n13, overrides: F6 }) {
  let [i13, a15] = (0, import_react47.useState)(null), p8 = p();
  return (0, import_react47.useEffect)(() => {
    if (n13 && i13) return p8.addEventListener(i13, "reset", n13);
  }, [i13, e7, n13]), import_react47.default.createElement(c2, null, import_react47.default.createElement(C, { setForm: a15, formId: e7 }), e2(t14).map(([s16, v7]) => import_react47.default.createElement(T2, { features: s4.Hidden, ...m2({ key: s16, as: "input", type: "hidden", hidden: true, readOnly: true, form: e7, disabled: r14, name: s16, value: v7, ...F6 }) })));
}
function C({ setForm: t14, formId: e7 }) {
  ...
  }, [t14, e7]), e7 ? null : import_react47.default.createElement(T2, { features: s4.Hidden, as: "input", type: "hidden", hidden: true, readOnly: true, ref: (r14) => {
    if (!r14) return;
    let n13 = r14.closest("form");
    n13 && t14(n13);
  } });
}
...
function f5({ id: t14, children: r14 }) {
  return import_react48.default.createElement(e3.Provider, { value: t14 }, r14);
}
...
function y(...t14) {
  ...
  let c13 = o4((e7) => {
    for (let o18 of n13.current) o18 != null && (typeof o18 == "function" ? o18(e7) : o18.current = e7);
  });
...
function f6() {
  let r14 = (0, import_react50.useContext)(a5);
  if (r14 === null) {
...
function G() {
  var r14, e7;
  return (e7 = (r14 = (0, import_react50.useContext)(a5)) == null ? void 0 : r14.value) != null ? e7 : void 0;
}
function U2() {
  let [r14, e7] = (0, import_react50.useState)([]);
  return [r14.length > 0 ? r14.join(" ") : void 0, (0, import_react50.useMemo)(() => function(t14) {
...
var S2 = "p";
function C2(r14, e7) {
  let d16 = (0, import_react46.useId)(), t14 = a3(), { id: i13 = `headlessui-description-${d16}`, ...l16 } = r14, n13 = f6(), s16 = y(e7);
...
function P4() {
  let r14 = (0, import_react51.useContext)(c4);
  if (r14 === null) {
...
function I2(r14) {
  ...
  return ((o18 = r14 == null ? void 0 : r14.length) != null ? o18 : 0) > 0 ? [l16, ...r14].filter(Boolean).join(" ") : l16;
}
function z({ inherit: r14 = false } = {}) {
  let l16 = I2(), [a15, e7] = (0, import_react51.useState)([]), o18 = r14 ? [l16, ...a15].filter(Boolean) : a15;
...
function G2(r14, l16) {
  var y9;
  let a15 = (0, import_react46.useId)(), e7 = P4(), o18 = u5(), g8 = a3(), { id: t14 = `headlessui-label-${a15}`, htmlFor: s16 = o18 != null ? o18 : (y9 = e7.props) == null ? void 0 : y9.htmlFor, passive: m13 = false, ...i13 } = r14, p8 = y(l16);
...
var se = "span";
function ie(T12, h7) {
  let C7 = (0, import_react46.useId)(), k5 = u5(), x6 = a3(), { id: g8 = k5 || `headlessui-checkbox-${C7}`, disabled: o18 = x6 || false, autoFocus: s16 = false, checked: E11, defaultChecked: v7, onChange: P7, name: d16, value: D9, form: R7, indeterminate: l16 = false, ...A7 } = T12, r14 = l2(v7), [a15, t14] = T(E11, P7, r14 != null ? r14 : false), F6 = I2(), K4 = G(), _6 = p(), [p8, c13] = (0, import_react52.useState)(false), m13 = o4(() => {
    ...
    if (r14 !== void 0) return t14 == null ? void 0 : t14(r14);
  }, [t14, r14]);
...
function u9(e7 = l7) {
  return (0, import_react55.useCallback)((r14, t14) => {
    if (typeof e7 == "string") {
      let o18 = e7;
      return (r14 == null ? void 0 : r14[o18]) === (t14 == null ? void 0 : t14[o18]);
    }
    return e7(r14, t14);
  }, [e7]);
}
...
function f7(e7, n13 = false) {
  let t14 = e7 === null ? null : "current" in e7 ? e7.current : e7, [l16, u17] = (0, import_react56.useReducer)(() => ({}), {}), r14 = (0, import_react56.useMemo)(() => s5(t14), [t14, l16]);
  return n(() => {
    if (!t14) return;
  ...
  }, [t14]), n13 ? { width: `${r14.width}px`, height: `${r14.height}px` } : r14;
}
...
function l8(t14) {
  var r14;
  let e7 = (r14 = u10.get(t14)) != null ? r14 : 0;
...
function p3(t14) {
  ...
  if (e7 === 1 ? u10.delete(t14) : u10.set(t14, e7 - 1), e7 !== 1) return;
  let r14 = f8.get(t14);
  r14 && (r14["aria-hidden"] === null ? t14.removeAttribute("aria-hidden") : t14.setAttribute("aria-hidden", r14["aria-hidden"]), t14.inert = r14.inert, f8.delete(t14));
}
function T6({ allowed: t14, disallowed: e7 } = {}, r14 = true) {
  n(() => {
    var s16, c13;
    if (!r14) return;
    let n13 = o2();
    for (let i13 of (s16 = e7 == null ? void 0 : e7()) != null ? s16 : []) i13 && n13.add(l8(i13));
    ...
    for (let i13 of a15) {
      ...
      for (; o18 && o18 !== d16.body; ) {
        for (let h7 of o18.children) a15.some((E11) => h7.contains(E11)) || n13.add(l8(h7));
...
function m6(n13, l16, s16 = true) {
  ...
  (0, import_react57.useEffect)(() => {
    ...
    let e7 = o2();
    if (typeof ResizeObserver != "undefined") {
      let r14 = new ResizeObserver(() => i13.current(t14));
      r14.observe(t14), e7.add(() => r14.disconnect());
    }
    if (typeof IntersectionObserver != "undefined") {
      let r14 = new IntersectionObserver(() => i13.current(t14));
      r14.observe(t14), e7.add(() => r14.disconnect());
    }
    return () => e7.dispose();
  }, [n13, i13, s16]);
...
function b2(e7 = document.body) {
  return e7 == null ? [] : Array.from(e7.querySelectorAll(f9)).sort((r14, t14) => Math.sign((r14.tabIndex || Number.MAX_SAFE_INTEGER) - (t14.tabIndex || Number.MAX_SAFE_INTEGER)));
}
function S3(e7 = document.body) {
  return e7 == null ? [] : Array.from(e7.querySelectorAll(p4)).sort((r14, t14) => Math.sign((r14.tabIndex || Number.MAX_SAFE_INTEGER) - (t14.tabIndex || Number.MAX_SAFE_INTEGER)));
}
var h4 = ((t14) => (t14[t14.Strict = 0] = "Strict", t14[t14.Loose = 1] = "Loose", t14))(h4 || {});
function A2(e7, r14 = 0) {
  var t14;
  return e7 === ((t14 = u(e7)) == null ? void 0 : t14.body) ? false : u2(r14, { [0]() {
...
function O2(e7) {
  var r14, t14;
  return (t14 = (r14 = e7 == null ? void 0 : e7.matches) == null ? void 0 : r14.call(e7, w5)) != null ? t14 : false;
}
function _2(e7, r14 = (t14) => t14) {
  return e7.slice().sort((t14, u17) => {
    let o18 = r14(t14), c13 = r14(u17);
    if (o18 === null || c13 === null) return 0;
...
function P5(e7, r14, { sorted: t14 = true, relativeTo: u17 = null, skipElements: o18 = [] } = {}) {
  let c13 = Array.isArray(e7) ? e7.length > 0 ? e7[0].ownerDocument : document : e7.ownerDocument, l16 = Array.isArray(e7) ? t14 ? _2(e7) : e7 : r14 & 64 ? S3(e7) : b2(e7);
  ...
  let n13 = (() => {
    ...
    if (r14 & 1) return 0;
    if (r14 & 2) return Math.max(0, l16.indexOf(u17)) - 1;
    if (r14 & 4) return Math.max(0, l16.indexOf(u17)) + 1;
    if (r14 & 8) return l16.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), M7 = r14 & 32 ? { preventScroll: true } : {}, m13 = 0, d16 = l16.length, i13;
  do {
    if (m13 >= d16 || m13 + d16 <= 0) return 0;
    let s16 = x6 + m13;
    if (r14 & 16) s16 = (s16 + d16) % d16;
    else {
      if (s16 < 0) return 3;
      if (s16 >= d16) return 1;
    }
  ...
  return r14 & 6 && O2(i13) && i13.select(), 2;
}
...
function w6(s16, m13, a15 = true) {
  ...
  function c13(e7, r14) {
    if (!i13.current || e7.defaultPrevented) return;
    let t14 = r14(e7);
    if (t14 === null || !t14.getRootNode().contains(t14) || !t14.isConnected) return;
    let E11 = function u17(n13) {
      return typeof n13 == "function" ? u17(n13()) : Array.isArray(n13) || n13 instanceof Set ? n13 : [n13];
    }(s16);
    for (let u17 of E11) {
      if (u17 === null) continue;
      let n13 = u17 instanceof HTMLElement ? u17 : u17.current;
      if (n13 != null && n13.contains(t14) || e7.composed && e7.composedPath().includes(n13)) return;
    }
  ...
  d3("pointerdown", (e7) => {
    var r14, t14;
    i13.current && (o18.current = ((t14 = (r14 = e7.composedPath) == null ? void 0 : r14.call(e7)) == null ? void 0 : t14[0]) || e7.target);
...
function E5(n13, e7, a15, t14) {
  ...
  (0, import_react62.useEffect)(() => {
    ...
    return n13.addEventListener(e7, r14, t14), () => n13.removeEventListener(e7, r14, t14);
  }, [n13, e7, t14]);
}
...
function d7() {
  ...
  return { before({ doc: e7 }) {
    ...
    r14 = Math.max(0, t14.innerWidth - o18.clientWidth);
  }, after({ doc: e7, d: o18 }) {
    let t14 = e7.documentElement, l16 = Math.max(0, t14.clientWidth - t14.offsetWidth), n13 = Math.max(0, r14 - l16);
...
function d8() {
  return t4() ? { before({ doc: r14, d: n13, meta: c13 }) {
    function o18(a15) {
    ...
    n13.microTask(() => {
      ...
      if (window.getComputedStyle(r14.documentElement).scrollBehavior !== "auto") {
        let t14 = o2();
        t14.style(r14.documentElement, "scrollBehavior", "auto"), n13.add(() => n13.microTask(() => t14.dispose()));
      }
      let a15 = (s16 = window.scrollY) != null ? s16 : window.pageYOffset, l16 = null;
      n13.addEventListener(r14, "click", (t14) => {
        if (t14.target instanceof HTMLElement) try {
          let e7 = t14.target.closest("a");
          if (!e7) return;
          let { hash: f20 } = new URL(e7.href), i13 = r14.querySelector(f20);
          i13 && !o18(i13) && (l16 = i13);
        } catch {
        }
      }, true), n13.addEventListener(r14, "touchstart", (t14) => {
        if (t14.target instanceof HTMLElement) if (o18(t14.target)) {
          let e7 = t14.target;
          for (; e7.parentElement && o18(e7.parentElement); ) e7 = e7.parentElement;
          n13.style(e7, "overscrollBehavior", "contain");
        } else n13.style(t14.target, "touchAction", "none");
      }), n13.addEventListener(r14, "touchmove", (t14) => {
        if (t14.target instanceof HTMLElement) {
          if (t14.target.tagName === "INPUT") return;
          if (o18(t14.target)) {
            let e7 = t14.target;
...
function m8(e7) {
  let n13 = {};
  for (let t14 of e7) Object.assign(n13, t14(n13));
  return n13;
}
var a7 = a6(() => /* @__PURE__ */ new Map(), { PUSH(e7, n13) {
  ...
  let o18 = { doc: e7, d: n13, meta: m8(t14) }, c13 = [d8(), d7(), r7()];
  c13.forEach(({ before: r14 }) => r14 == null ? void 0 : r14(o18)), c13.forEach(({ after: r14 }) => r14 == null ? void 0 : r14(o18));
}, SCROLL_ALLOW({ d: e7 }) {
  e7.dispose();
}, TEARDOWN({ doc: e7 }) {
  this.delete(e7);
...
a7.subscribe(() => {
  ...
  for (let [t14] of e7) n13.set(t14, t14.documentElement.style.overflow);
...
function a8(e7, r14, n13 = () => ({ containers: [] })) {
  let f20 = o12(a7), o18 = e7 ? f20.get(e7) : void 0, i13 = o18 ? o18.count > 0 : false;
  return n(() => {
    if (!(!e7 || !r14)) return a7.dispatch("PUSH", e7, n13), () => a7.dispatch("POP", e7, n13);
  }, [r14, e7]), i13;
}
...
function F2({ container: e7, accept: t14, walk: r14, enabled: c13 = true }) {
  let o18 = (0, import_react67.useRef)(t14), l16 = (0, import_react67.useRef)(r14);
  (0, import_react67.useEffect)(() => {
    o18.current = t14, l16.current = r14;
  }, [t14, r14]), n(() => {
    if (!e7 || !c13) return;
    let n13 = u(e7);
    if (!n13) return;
    ...
    for (; u17.nextNode(); ) p8(u17.currentNode);
  }, [e7, c13, o18, l16]);
}
...
function m10(u17, t14) {
  let e7 = (0, import_react68.useRef)([]), r14 = o4(u17);
  (0, import_react68.useEffect)(() => {
    let o18 = [...e7.current];
    for (let [a15, l16] of t14.entries()) if (e7.current[a15] !== l16) {
      let n13 = r14(t14, o18);
...
function Re2(e7 = null) {
  ...
  let t14 = (0, import_react72.useContext)(S4), n13 = (0, import_react72.useMemo)(() => e7, [JSON.stringify(e7, typeof HTMLElement != "undefined" ? (a15, r14) => r14 instanceof HTMLElement ? r14.outerHTML : r14 : void 0)]);
  n(() => {
...
function ve({ children: e7, enabled: t14 = true }) {
  let [n13, l16] = (0, import_react72.useState)(null), [a15, r14] = (0, import_react72.useState)(0), c13 = (0, import_react72.useRef)(null), [u17, i13] = (0, import_react72.useState)(null);
  pe(u17);
  ...
  let { refs: b7, floatingStyles: $5, context: g8 } = useFloating2({ open: o18, placement: s16 === "selection" ? f20 === "center" ? "bottom" : `bottom-${f20}` : f20 === "center" ? `${s16}` : `${s16}-${f20}`, strategy: "absolute", transform: false, middleware: [offset3({ mainAxis: s16 === "selection" ? 0 : C7, crossAxis: M7 }), shift3({ padding: p8 }), s16 !== "selection" && flip3({ padding: p8 }), s16 === "selection" && P7 ? inner({ ...P7, padding: p8, overflowRef: c13, offset: a15, minItemsVisible: q, referenceOverflowThreshold: p8, onFallbackChange(h7) {
    ...
    for (let m13 of (k5 = (W6 = g8.elements.floating) == null ? void 0 : W6.childNodes) != null ? k5 : []) if (m13 instanceof HTMLElement) {
  ...
  let G10 = (0, import_react72.useMemo)(() => ({ anchor: [I5, V6].filter(Boolean).join(" ") }), [I5, V6]), K4 = useInnerOffset(g8, { overflowRef: c13, onChange: r14 }), { getReferenceProps: Q6, getFloatingProps: X3 } = useInteractions([K4]), Y4 = o4((h7) => {
...
function ce(e7, t14) {
  var r14, c13, u17;
  let n13 = L((r14 = e7 == null ? void 0 : e7.gap) != null ? r14 : "var(--anchor-gap, 0)", t14), l16 = L((c13 = e7 == null ? void 0 : e7.offset) != null ? c13 : "var(--anchor-offset, 0)", t14), a15 = L((u17 = e7 == null ? void 0 : e7.padding) != null ? u17 : "var(--anchor-padding, 0)", t14);
  return { ...e7, gap: n13, offset: l16, padding: a15 };
}
function L(e7, t14, n13 = void 0) {
  let l16 = p(), a15 = o4((i13, o18) => {
    if (i13 == null) return [n13, null];
    if (typeof i13 == "number") return [i13, null];
    if (typeof i13 == "string") {
      if (!o18) return [n13, null];
      let F6 = J(i13, o18);
      return [F6, (C7) => {
        let M7 = D3(i13);
        {
    ...
    return [n13, null];
  }), r14 = (0, import_react72.useMemo)(() => a15(e7, t14)[0], [e7, t14]), [c13 = r14, u17] = (0, import_react72.useState)();
  return n(() => {
    let [i13, o18] = a15(e7, t14);
    if (u17(i13), !!o18) return o18(u17);
  }, [e7, t14]), c13;
}
function D3(e7) {
  let t14 = /var\((.*)\)/.exec(e7);
...
function s8({ value: o18, children: r14 }) {
  return import_react73.default.createElement(n9.Provider, { value: o18 }, r14);
}
...
t8(() => {
  function e7(n13) {
    n13.target instanceof HTMLElement && n13.target !== document.body && t9[0] !== n13.target && (t9.unshift(n13.target), t9 = t9.filter((r14) => r14 != null && r14.isConnected), t9.splice(10));
  }
...
function f13(l16, n13) {
  ...
  let r14 = n13.resolveActiveIndex(), s16 = r14 != null ? r14 : -1;
  switch (l16.focus) {
    case 0: {
      for (let e7 = 0; e7 < t14.length; ++e7) if (!n13.resolveDisabled(t14[e7], e7, t14)) return e7;
      return r14;
    }
    case 1: {
      s16 === -1 && (s16 = t14.length);
      for (let e7 = s16 - 1; e7 >= 0; --e7) if (!n13.resolveDisabled(t14[e7], e7, t14)) return e7;
      return r14;
    }
    case 2: {
      for (let e7 = s16 + 1; e7 < t14.length; ++e7) if (!n13.resolveDisabled(t14[e7], e7, t14)) return e7;
      return r14;
    }
    case 3: {
      for (let e7 = t14.length - 1; e7 >= 0; --e7) if (!n13.resolveDisabled(t14[e7], e7, t14)) return e7;
      return r14;
    }
    case 4: {
      for (let e7 = 0; e7 < t14.length; ++e7) if (n13.resolveId(t14[e7], e7, t14) === l16.id) return e7;
      return r14;
    }
    case 5:
      return null;
...
function c7(t14) {
  let r14 = o4(t14), e7 = (0, import_react74.useRef)(false);
...
function l10() {
  let r14 = s9(), [e7, n13] = t10.useState(s.isHandoffComplete);
...
// node_modules/@headlessui/react/dist/components/portal/portal.js
function D4(p8) {
  let r14 = a9(), l16 = (0, import_react76.useContext)(v4), e7 = n8(p8), [o18, n13] = (0, import_react76.useState)(() => {
    var t14;
    if (!r14 && l16 !== null) return (t14 = l16.current) != null ? t14 : null;
  ...
  return (0, import_react76.useEffect)(() => {
    ...
    r14 || l16 !== null && n13(l16.current);
  }, [l16, n13, r14]), o18;
}
var M2 = import_react76.Fragment;
var N4 = I(function(r14, l16) {
  let e7 = r14, o18 = (0, import_react76.useRef)(null), n13 = y(T3((i13) => {
    o18.current = i13;
  ...
  return n(() => {
    ...
    if (t14 && s16) return s16.register(t14);
  }, [s16, t14]), c7(() => {
    var i13;
...
function S5(p8, r14) {
  let l16 = y(r14), { enabled: e7 = true, ...o18 } = p8;
...
function W2(p8, r14) {
  let { target: l16, ...e7 } = p8, n13 = { ref: y(r14) };
...
function ee() {
  let p8 = (0, import_react76.useContext)(y5), r14 = (0, import_react76.useRef)([]), l16 = o4((n13) => (r14.current.push(n13), p8 && p8.register(n13), () => e7(n13))), e7 = o4((n13) => {
    let u17 = r14.current.indexOf(n13);
    u17 !== -1 && r14.current.splice(u17, 1), p8 && p8.unregister(n13);
  }), o18 = (0, import_react76.useMemo)(() => ({ register: l16, unregister: e7, portals: r14 }), [l16, e7, r14]);
  return [r14, (0, import_react76.useMemo)(() => function({ children: u17 }) {
...
function Te(o18, r14 = (e7) => e7) {
  let e7 = o18.activeOptionIndex !== null ? o18.options[o18.activeOptionIndex] : null, t14 = r14(o18.options.slice()), c13 = t14.length > 0 && t14[0].dataRef.current.order !== null ? t14.sort((d16, i13) => d16.dataRef.current.order - i13.dataRef.current.order) : _2(t14, (d16) => d16.dataRef.current.domRef.current), s16 = e7 ? c13.indexOf(e7) : null;
  return s16 === -1 && (s16 = null), { options: c13, activeOptionIndex: s16 };
}
var Oo = { [1](o18) {
  var r14;
  return (r14 = o18.dataRef.current) != null && r14.disabled || o18.comboboxState === 1 ? o18 : { ...o18, activeOptionIndex: null, comboboxState: 1, activationTrigger: 2, __demoMode: false };
}, [0](o18) {
  var r14, e7;
  if ((r14 = o18.dataRef.current) != null && r14.disabled || o18.comboboxState === 0) return o18;
  if ((e7 = o18.dataRef.current) != null && e7.value) {
    let t14 = o18.dataRef.current.calculateIndex(o18.dataRef.current.value);
    if (t14 !== -1) return { ...o18, activeOptionIndex: t14, comboboxState: 0, __demoMode: false };
  }
  return { ...o18, comboboxState: 0, __demoMode: false };
}, [2](o18, r14) {
  var s16, d16, i13, m13, n13;
  if ((s16 = o18.dataRef.current) != null && s16.disabled || (d16 = o18.dataRef.current) != null && d16.optionsRef.current && !((i13 = o18.dataRef.current) != null && i13.optionsPropsRef.current.static) && o18.comboboxState === 1) return o18;
  if (o18.virtual) {
    let { options: p8, disabled: f20 } = o18.virtual, _6 = r14.focus === c6.Specific ? r14.idx : f13(r14, { resolveItems: () => p8, resolveActiveIndex: () => {
      var u17, x6;
      return (x6 = (u17 = o18.activeOptionIndex) != null ? u17 : p8.findIndex((V6) => !f20(V6))) != null ? x6 : null;
    }, resolveDisabled: f20, resolveId() {
      throw new Error("Function not implemented.");
    } }), F6 = (m13 = r14.trigger) != null ? m13 : 2;
  ...
  let t14 = r14.focus === c6.Specific ? r14.idx : f13(r14, { resolveItems: () => e7.options, resolveActiveIndex: () => e7.activeOptionIndex, resolveId: (p8) => p8.id, resolveDisabled: (p8) => p8.dataRef.current.disabled }), c13 = (n13 = r14.trigger) != null ? n13 : 2;
  ...
  var s16, d16, i13;
  if ((s16 = o18.dataRef.current) != null && s16.virtual) return { ...o18, options: [...o18.options, r14.payload] };
  let e7 = r14.payload, t14 = Te(o18, (m13) => (m13.push(e7), m13));
  o18.activeOptionIndex === null && (d16 = o18.dataRef.current) != null && d16.isSelected(r14.payload.dataRef.current.value) && (t14.activeOptionIndex = t14.options.indexOf(e7));
  ...
  var t14;
  if ((t14 = o18.dataRef.current) != null && t14.virtual) return { ...o18, options: o18.options.filter((c13) => c13.id !== r14.id) };
  let e7 = Te(o18, (c13) => {
    let s16 = c13.findIndex((d16) => d16.id === r14.id);
    return s16 !== -1 && c13.splice(s16, 1), c13;
  });
  return { ...o18, ...e7, activationTrigger: 2 };
}, [5]: (o18, r14) => o18.activationTrigger === r14.trigger ? o18 : { ...o18, activationTrigger: r14.trigger }, [6]: (o18, r14) => {
  var t14, c13;
  if (o18.virtual === null) return { ...o18, virtual: { options: r14.options, disabled: (t14 = r14.disabled) != null ? t14 : () => false } };
  if (o18.virtual.options === r14.options && o18.virtual.disabled === r14.disabled) return o18;
  let e7 = o18.activeOptionIndex;
  if (o18.activeOptionIndex !== null) {
    let s16 = r14.options.indexOf(o18.virtual.options[o18.activeOptionIndex]);
    s16 !== -1 ? e7 = s16 : e7 = null;
  }
  return { ...o18, activeOptionIndex: e7, virtual: { options: r14.options, disabled: (c13 = r14.disabled) != null ? c13 : () => false } };
} };
var ge = (0, import_react77.createContext)(null);
ge.displayName = "ComboboxActionsContext";
function oe(o18) {
  let r14 = (0, import_react77.useContext)(ge);
  if (r14 === null) {
...
function Co(o18) {
  let r14 = Q("VirtualProvider"), { options: e7 } = r14.virtual, [t14, c13] = (0, import_react77.useMemo)(() => {
    let n13 = r14.optionsRef.current;
    if (!n13) return [0, 0];
  ...
  }, [r14.optionsRef.current]), s16 = useVirtualizer({ scrollPaddingStart: t14, scrollPaddingEnd: c13, count: e7.length, estimateSize() {
    return 40;
  }, getScrollElement() {
    var n13;
    return (n13 = r14.optionsRef.current) != null ? n13 : null;
  ...
  return m13.length === 0 ? null : import_react77.default.createElement(Le.Provider, { value: s16 }, import_react77.default.createElement("div", { style: { position: "relative", width: "100%", height: `${s16.getTotalSize()}px` }, ref: (n13) => {
    if (n13) {
      if (typeof process != "undefined" && process.env.JEST_WORKER_ID !== void 0 || r14.activationTrigger === 0) return;
      r14.activeOptionIndex !== null && e7.length > r14.activeOptionIndex && s16.scrollToIndex(r14.activeOptionIndex);
    }
  } }, m13.map((n13) => {
    var p8;
    return import_react77.default.createElement(import_react77.Fragment, { key: n13.key }, import_react77.default.cloneElement((p8 = o18.children) == null ? void 0 : p8.call(o18, { option: e7[n13.index], open: r14.comboboxState === 0 }), { key: `${d16}-${n13.key}`, "data-index": n13.index, "aria-setsize": e7.length, "aria-posinset": n13.index + 1, style: { position: "absolute", top: 0, left: 0, transform: `translateY(${n13.start}px)`, overflowAnchor: "none" } }));
  })));
}
var se2 = (0, import_react77.createContext)(null);
se2.displayName = "ComboboxDataContext";
function Q(o18) {
  let r14 = (0, import_react77.useContext)(se2);
  if (r14 === null) {
    let e7 = new Error(`<${o18} /> is missing a parent <Combobox /> component.`);
...
function So(o18, r14) {
  ...
  let j11 = (0, import_react77.useMemo)(() => {
    ...
    if (a15.activeOptionIndex !== null) {
      if (a15.virtual) q6(a15.virtual.options[a15.activeOptionIndex]);
      else {
  ...
  }), l16 = (0, import_react77.useMemo)(() => ({ onChange: q6, registerOption: re2, goToOption: ne3, closeCombobox: te4, openCombobox: be4, setActivationTrigger: ie3, selectActiveOption: de4 }), []), [B3, E11] = z(), k5 = r14 === null ? {} : { ref: r14 }, R7 = (0, import_react77.useCallback)(() => {
    if (P7 !== void 0) return y9 == null ? void 0 : y9(P7);
  }, [y9, P7]);
...
function Io(o18, r14) {
  ...
  let e7 = Q("Combobox.Input"), t14 = oe("Combobox.Input"), c13 = (0, import_react46.useId)(), s16 = u5(), { id: d16 = s16 || `headlessui-combobox-input-${c13}`, onChange: i13, displayValue: m13, disabled: n13 = e7.disabled || false, autoFocus: p8 = false, type: f20 = "text", ..._6 } = o18, F6 = y(e7.inputRef, r14, ye()), u17 = n8(e7.inputRef), x6 = (0, import_react77.useRef)(false), V6 = p(), P7 = o4(() => {
  ...
  let y9 = (0, import_react77.useRef)(false), I5 = o4(() => {
    ...
    switch (x6.current = true, h7(() => {
      ...
      case o8.Enter:
        if (x6.current = false, e7.comboboxState !== 0 || y9.current) return;
      ...
      case o8.Tab:
        if (x6.current = false, e7.comboboxState !== 0) return;
    ...
    if (x6.current = false, !((k5 = e7.optionsRef.current) != null && k5.contains(B3)) && !((R7 = e7.buttonRef.current) != null && R7.contains(B3)) && e7.comboboxState === 0) return l16.preventDefault(), e7.mode === 0 && e7.value === null && P7(), t14.closeCombobox();
  }), z7 = o4((l16) => {
    var E11, k5, R7;
    let B3 = (E11 = l16.relatedTarget) != null ? E11 : t9.find((D9) => D9 !== l16.currentTarget);
...
function Eo(o18, r14) {
  var w10;
  let e7 = Q("Combobox.Button"), t14 = oe("Combobox.Button"), c13 = y(e7.buttonRef, r14), s16 = (0, import_react46.useId)(), { id: d16 = `headlessui-combobox-button-${s16}`, disabled: i13 = e7.disabled || false, autoFocus: m13 = false, ...n13 } = o18, p8 = p(), f20 = f11(e7.inputRef), _6 = o4((O3) => {
    switch (O3.key) {
      case o8.Space:
      case o8.Enter:
    ...
    O3.preventDefault(), !r4(O3.currentTarget) && (O3.button === g2.Left && (e7.comboboxState === 0 ? t14.closeCombobox() : t14.openCombobox()), f20());
...
function ho(o18, r14) {
  ...
  f20 && (d16 = true);
  let [_6, F6] = Re2(f20), u17 = be(), x6 = y(n13.optionsRef, r14, f20 ? _6 : null), V6 = n8(n13.optionsRef), P7 = u13(), C7 = (() => P7 !== null ? (P7 & d9.Open) === d9.Open : n13.comboboxState === 0)();
...
function Mo(o18, r14) {
  ...
  n(() => {
    ...
    if (C7.current && e7.comboboxState === 0 && f20 && e7.activationTrigger !== 0) return o2().requestAnimationFrame(() => {
      var a15, j11;
...
function _4(o18, n13) {
  let { ...p8 } = o18, e7 = false, { isFocusVisible: t14, focusProps: s16 } = $f7dceffc5ad7768b$export$4e328f61c538687f(), { isHovered: r14, hoverProps: i13 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e7 }), { pressed: a15, pressProps: T12 } = w({ disabled: e7 }), l16 = D({ ref: n13 }, s16, i13, T12), m13 = (0, import_react78.useMemo)(() => ({ hover: r14, focus: t14, active: a15 }), [r14, t14, a15]);
...
function j6({ defaultContainers: o18 = [], portals: r14, mainTreeNodeRef: u17 } = {}) {
  var f20;
  let t14 = (0, import_react80.useRef)((f20 = u17 == null ? void 0 : u17.current) != null ? f20 : null), l16 = n8(t14), c13 = o4(() => {
    var i13, s16, a15;
    let n13 = [];
    for (let e7 of o18) e7 !== null && (e7 instanceof HTMLElement ? n13.push(e7) : "current" in e7 && e7.current instanceof HTMLElement && n13.push(e7.current));
    if (r14 != null && r14.current) for (let e7 of r14.current) n13.push(e7);
    for (let e7 of (i13 = l16 == null ? void 0 : l16.querySelectorAll("html > *, body > *")) != null ? i13 : []) e7 !== document.body && e7 !== document.head && e7 instanceof HTMLElement && e7.id !== "headlessui-portal-root" && (e7.contains(t14.current) || e7.contains((a15 = (s16 = t14.current) == null ? void 0 : s16.getRootNode()) == null ? void 0 : a15.host) || n13.some((L9) => e7.contains(L9)) || n13.push(e7));
    return n13;
  });
...
function b3({ children: i13, onUpdate: r14, type: e7, element: n13, enabled: u17 }) {
  let l16 = x2(), o18 = o4((...t14) => {
    r14 == null || r14(...t14), l16(...t14);
  });
  return n(() => {
...
// node_modules/@headlessui/react/dist/components/focus-trap/focus-trap.js
function S6(t14) {
  if (!t14) return /* @__PURE__ */ new Set();
  if (typeof t14 == "function") return new Set(t14());
  let o18 = /* @__PURE__ */ new Set();
  for (let e7 of t14.current) e7.current instanceof HTMLElement && o18.add(e7.current);
  return o18;
}
var z2 = "div";
...
function Q2(t14, o18) {
  let e7 = (0, import_react84.useRef)(null), n13 = y(e7, o18), { initialFocus: c13, initialFocusFallback: p8, containers: u17, features: r14 = 30, ...l16 } = t14;
  l10() || (r14 = 1);
  let s16 = n8(e7);
  $({ ownerDocument: s16 }, !!(r14 & 16));
  let U5 = D6({ ownerDocument: s16, container: e7, initialFocus: c13, initialFocusFallback: p8 }, r14);
  w7({ ownerDocument: s16, container: e7, containers: u17, previousActiveElement: U5 }, !!(r14 & 8));
  ...
  return import_react84.default.createElement(import_react84.default.Fragment, null, !!(r14 & 4) && import_react84.default.createElement(T2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: A7, features: s4.Focusable }), H({ ourProps: x6, theirProps: l16, defaultTag: z2, name: "FocusTrap" }), !!(r14 & 4) && import_react84.default.createElement(T2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: A7, features: s4.Focusable }));
}
var Y = I(Q2);
...
function D6({ ownerDocument: t14, container: o18, initialFocus: e7, initialFocusFallback: n13 }, c13) {
  let p8 = !!(c13 & 2), u17 = (0, import_react84.useRef)(null), r14 = f17();
  return m10(() => {
    if (!p8) {
    ...
    l16 && t(() => {
      ...
      if (e7 != null && e7.current) I3(e7.current);
      else {
        if (c13 & 32) {
          if (P5(l16, F.First | F.AutoFocus) !== T7.Error) return;
        } else if (P5(l16, F.First) !== T7.Error) return;
        if (n13 != null && n13.current && (I3(n13.current), (t14 == null ? void 0 : t14.activeElement) === n13.current)) return;
...
function w7({ ownerDocument: t14, container: o18, containers: e7, previousActiveElement: n13 }, c13) {
  ...
  E5(t14 == null ? void 0 : t14.defaultView, "focus", (u17) => {
    if (!c13 || !p8.current) return;
    let r14 = S6(e7);
    o18.current instanceof HTMLElement && r14.add(o18.current);
    let l16 = n13.current;
    if (!l16) return;
    let s16 = u17.target;
    s16 && s16 instanceof HTMLElement ? j7(r14, s16) ? (n13.current = s16, I3(s16)) : (u17.preventDefault(), u17.stopPropagation(), I3(l16)) : I3(n13.current);
  }, true);
}
function j7(t14, o18) {
  for (let e7 of t14) if (e7.contains(o18)) return true;
  return false;
}
...
function M4(o18) {
  ...
  if (t14 === null) {
    let r14 = new Error(`<${o18} /> is missing a parent <Dialog /> component.`);
...
function We(o18, t14) {
  let r14 = (0, import_react46.useId)(), { id: d16 = `headlessui-dialog-${r14}`, open: i13, onClose: s16, initialFocus: f20, role: a15 = "dialog", autoFocus: D9 = true, __demoMode: p8 = false, ...G10 } = o18, [R7, H10] = (0, import_react85.useState)(0), N5 = (0, import_react85.useRef)(false);
  a15 = function() {
  ...
  if (!k5 && !U5) throw new Error("You have to provide an `open` and an `onClose` prop to the `Dialog` component.");
  if (!k5) throw new Error("You provided an `onClose` prop to the `Dialog`, but forgot an `open` prop.");
  if (!U5) throw new Error("You provided an `open` prop to the `Dialog`, but forgot an `onClose` prop.");
  if (typeof i13 != "boolean") throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${i13}`);
  if (typeof s16 != "function") throw new Error(`You provided an \`onClose\` prop to the \`Dialog\`, but the value is not a function. Received: ${s16}`);
...
var Ye = "div";
function Je(o18, t14) {
  let r14 = (0, import_react46.useId)(), { id: d16 = `headlessui-dialog-panel-${r14}`, ...i13 } = o18, [{ dialogState: s16 }, f20] = M4("Dialog.Panel"), a15 = y(t14, f20.panelRef), D9 = (0, import_react85.useMemo)(() => ({ open: s16 === 0 }), [s16]), p8 = o4((R7) => {
    R7.stopPropagation();
  });
...
function Be2(o18, t14) {
  let r14 = (0, import_react46.useId)(), { id: d16 = `headlessui-dialog-title-${r14}`, ...i13 } = o18, [{ dialogState: s16, setTitleId: f20 }] = M4("Dialog.Title"), a15 = y(t14);
...
function De2(e7, n13) {
  let { defaultOpen: o18 = false, ...d16 } = e7, u17 = (0, import_react87.useRef)(null), r14 = y(n13, T3((c13) => {
    u17.current = c13;
    ...
    y9 == null || y9.focus();
  }), m13 = (0, import_react87.useMemo)(() => ({ close: p8 }), [p8]), D9 = (0, import_react87.useMemo)(() => ({ open: f20 === 0, close: p8 }), [f20, p8]), I5 = { ref: r14 };
...
var Pe2 = "button";
function ye4(e7, n13) {
  let o18 = (0, import_react46.useId)(), { id: d16 = `headlessui-disclosure-button-${o18}`, disabled: u17 = false, autoFocus: r14 = false, ...t14 } = e7, [l16, i13] = F3("Disclosure.Button"), f20 = de(), s16 = f20 === null ? false : f20 === l16.panelId, T12 = (0, import_react87.useRef)(null), p8 = y(T12, n13, s16 ? null : l16.buttonRef), m13 = U();
  (0, import_react87.useEffect)(() => {
    if (!s16) return i13({ type: 2, buttonId: d16 }), () => {
  ...
  let D9 = o4((a15) => {
    var E11;
    if (s16) {
      if (l16.disclosureState === 1) return;
      switch (a15.key) {
        case o8.Space:
        case o8.Enter:
    ...
    var E11;
    r4(a15.currentTarget) || u17 || (s16 ? (i13({ type: 0 }), (E11 = l16.buttonRef.current) == null || E11.focus()) : i13({ type: 0 }));
  }), { isFocusVisible: P7, focusProps: y9 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: r14 }), { isHovered: U5, hoverProps: h7 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: u17 }), { pressed: N5, pressProps: w10 } = w({ disabled: u17 }), q6 = (0, import_react87.useMemo)(() => ({ open: l16.disclosureState === 0, hover: U5, active: N5, disabled: u17, focus: P7, autofocus: r14 }), [l16, U5, N5, P7, u17, r14]), G10 = T8(e7, T12), z7 = s16 ? D({ ref: p8, type: G10, disabled: u17 || void 0, autoFocus: r14, onKeyDown: D9, onClick: c13 }, y9, h7, w10) : D({ ref: p8, id: d16, type: G10, "aria-expanded": l16.disclosureState === 0, "aria-controls": l16.linkedPanel ? l16.panelId : void 0, disabled: u17 || void 0, autoFocus: r14, onKeyDown: D9, onKeyUp: I5, onClick: c13 }, y9, h7, w10);
...
function ge2(e7, n13) {
  let o18 = (0, import_react46.useId)(), { id: d16 = `headlessui-disclosure-panel-${o18}`, ...u17 } = e7, [r14, t14] = F3("Disclosure.Panel"), { close: l16 } = V2("Disclosure.Panel"), i13 = U(), f20 = y(n13, r14.panelRef, (D9) => {
    a11(() => t14({ type: D9 ? 4 : 5 }));
  });
  (0, import_react87.useEffect)(() => (t14({ type: 3, panelId: d16 }), () => {
    t14({ type: 3, panelId: null });
  }), [d16, t14]);
  let s16 = u13(), T12 = (() => s16 !== null ? (s16 & d9.Open) === d9.Open : r14.disclosureState === 0)(), p8 = (0, import_react87.useMemo)(() => ({ open: r14.disclosureState === 0, close: l16 }), [r14, l16]), m13 = { ref: f20, id: d16 };
  return import_react87.default.createElement(H6.Provider, { value: r14.panelId }, H({ mergeRefs: i13, ourProps: m13, theirProps: u17, slot: p8, defaultTag: me2, features: Ee, visible: T12, name: "Disclosure.Panel" }));
}
var Se2 = I(De2);
var be2 = I(ye4);
var Re4 = I(ge2);
...
function A5(t14, i13) {
  var s16;
  let a15 = a3(), { disabled: e7 = a15 || false, ...p8 } = t14, [n13, T12] = l13((s16 = t14.as) != null ? s16 : d13), l16 = y(i13, T12), [r14, f20] = z(), m13 = (0, import_react90.useMemo)(() => ({ disabled: e7 }), [e7]);
  return import_react90.default.createElement(l, { value: e7 }, import_react90.default.createElement(f20, null, H({ ourProps: n13 === "fieldset" ? { ref: l16, "aria-labelledby": r14, disabled: e7 || void 0 } : { ref: l16, role: "group", "aria-labelledby": r14, "aria-disabled": e7 || void 0 }, theirProps: p8, slot: m13, defaultTag: d13, name: "Fieldset" })));
}
var C4 = I(A5);
...
var x4 = "input";
function h6(n13, s16) {
  let a15 = (0, import_react46.useId)(), l16 = u5(), i13 = a3(), { id: d16 = l16 || `headlessui-input-${a15}`, disabled: e7 = i13 || false, autoFocus: o18 = false, invalid: t14 = false, ...u17 } = n13, f20 = I2(), m13 = G(), { isFocused: r14, focusProps: T12 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: o18 }), { isHovered: p8, hoverProps: b7 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e7 }), y9 = D({ ref: s16, id: d16, "aria-labelledby": f20, "aria-describedby": m13, "aria-invalid": t14 ? "" : void 0, disabled: e7 || void 0, autoFocus: o18 }, T12, b7), I5 = (0, import_react91.useMemo)(() => ({ disabled: e7, invalid: t14, hover: p8, focus: r14, autofocus: o18 }), [e7, t14, p8, r14, o18]);
...
function i11(e7, o18) {
  let [u17, t14] = (0, import_react93.useState)(e7), r14 = s3(e7);
  return n(() => t14(r14.current), [r14, t14, ...o18]), u17;
}
...
function p7(e7, r14 = true) {
  ...
  if (n(() => {
    ...
    l16 && (t14.current = l16);
  }, [r14]), e7.current == null || !r14 || e7.current === document.activeElement) return false;
...
function o17(e7) {
  var r14, i13;
  let n13 = (r14 = e7.innerText) != null ? r14 : "", t14 = e7.cloneNode(true);
  if (!(t14 instanceof HTMLElement)) return n13;
  let u17 = false;
  for (let f20 of t14.querySelectorAll('[hidden],[aria-hidden],[role="img"]')) f20.remove(), u17 = true;
...
function g6(e7) {
  ...
  if (t14) {
    let u17 = t14.split(" ").map((l16) => {
      let r14 = document.getElementById(l16);
      if (r14) {
        let i13 = r14.getAttribute("aria-label");
        return typeof i13 == "string" ? i13.trim() : o17(r14).trim();
      }
      return null;
    }).filter(Boolean);
...
// node_modules/@headlessui/react/dist/hooks/use-text-value.js
function s13(c13) {
  let t14 = (0, import_react95.useRef)(""), r14 = (0, import_react95.useRef)("");
  return o4(() => {
    let e7 = c13.current;
    if (!e7) return "";
    let u17 = e7.innerText;
    if (t14.current === u17) return r14.current;
    let n13 = g6(e7).trim().toLowerCase();
    return t14.current = u17, r14.current = n13, n13;
  });
}
...
var Ot = { [1](e7) {
  ...
  if (a15.focus === c6.Nothing) return { ...o18, activeOptionIndex: null };
  if (a15.focus === c6.Specific) return { ...o18, activeOptionIndex: e7.options.findIndex((r14) => r14.id === a15.id) };
  if (a15.focus === c6.Previous) {
    let r14 = e7.activeOptionIndex;
    if (r14 !== null) {
      let R7 = e7.options[r14].dataRef.current.domRef, c13 = f13(a15, { resolveItems: () => e7.options, resolveActiveIndex: () => e7.activeOptionIndex, resolveId: (d16) => d16.id, resolveDisabled: (d16) => d16.dataRef.current.disabled });
      if (c13 !== null) {
        let d16 = e7.options[c13].dataRef.current.domRef;
        if (((O3 = R7.current) == null ? void 0 : O3.previousElementSibling) === d16.current || ((i13 = d16.current) == null ? void 0 : i13.previousElementSibling) === null) return { ...o18, activeOptionIndex: c13 };
      }
    }
    ...
    if (r14 !== null) {
      ...
      if (c13 !== null) {
        let d16 = e7.options[c13].dataRef.current.domRef;
        if (((l16 = R7.current) == null ? void 0 : l16.nextElementSibling) === d16.current || ((t14 = d16.current) == null ? void 0 : t14.nextElementSibling) === null) return { ...o18, activeOptionIndex: c13 };
      }
    }
  }
  let n13 = ae3(e7), u17 = f13(a15, { resolveItems: () => n13.options, resolveActiveIndex: () => n13.activeOptionIndex, resolveId: (r14) => r14.id, resolveDisabled: (r14) => r14.dataRef.current.disabled });
...
function gt(e7, a15) {
  var se5;
  let o18 = a3(), { value: n13, defaultValue: u17, form: T12, name: O3, onChange: i13, by: l16, invalid: t14 = false, disabled: r14 = o18 || false, horizontal: R7 = false, multiple: c13 = false, __demoMode: d16 = false, ...E11 } = e7;
  const U5 = R7 ? "horizontal" : "vertical";
  let w10 = y(a15), _6 = l2(u17), [g8 = c13 ? [] : void 0, y9] = T(n13, i13, _6), [I5, v7] = (0, import_react96.useReducer)(yt, { dataRef: (0, import_react96.createRef)(), listboxState: d16 ? 0 : 1, options: [], searchQuery: "", activeOptionIndex: null, activationTrigger: 1, optionsVisible: false, __demoMode: d16 }), B3 = (0, import_react96.useRef)({ static: false, hold: false }), M7 = (0, import_react96.useRef)(null), x6 = (0, import_react96.useRef)(null), A7 = (0, import_react96.useRef)(/* @__PURE__ */ new Map()), h7 = u9(l16), N5 = (0, import_react96.useCallback)((b7) => u2(p8.mode, { [1]: () => g8.some((L9) => h7(L9, b7)), [0]: () => h7(g8, b7) }), [g8]), p8 = (0, import_react96.useMemo)(() => ({ ...I5, value: g8, disabled: r14, invalid: t14, mode: c13 ? 1 : 0, orientation: U5, compare: h7, isSelected: N5, optionsPropsRef: B3, buttonRef: M7, optionsRef: x6, listRef: A7 }), [g8, r14, t14, c13, I5, A7]);
  n(() => {
  ...
  let G10 = (0, import_react96.useMemo)(() => ({ open: p8.listboxState === 0, disabled: r14, invalid: t14, value: g8 }), [p8, r14, g8, t14]), Y4 = o4((b7) => {
    ...
    if (_6 !== void 0) return y9 == null ? void 0 : y9(_6);
  }, [y9, _6]);
  return import_react96.default.createElement(ge4, { value: ve5, props: { htmlFor: (se5 = p8.buttonRef.current) == null ? void 0 : se5.id }, slot: { open: p8.listboxState === 0, disabled: r14 } }, import_react96.default.createElement(ve, null, import_react96.default.createElement(le.Provider, { value: ye7 }, import_react96.default.createElement(q2.Provider, { value: p8 }, import_react96.default.createElement(s8, { value: u2(p8.listboxState, { [0]: d9.Open, [1]: d9.Closed }) }, O3 != null && g8 != null && import_react96.default.createElement(j2, { disabled: r14, data: { [O3]: g8 }, form: T12, onReset: Se5 }), H({ ourProps: Le6, theirProps: E11, slot: G10, defaultTag: vt, name: "Listbox" }))))));
}
var Lt = "button";
function St(e7, a15) {
  var N5;
  let o18 = W3("Listbox.Button"), n13 = $2("Listbox.Button"), u17 = (0, import_react46.useId)(), T12 = u5(), { id: O3 = T12 || `headlessui-listbox-button-${u17}`, disabled: i13 = o18.disabled || false, autoFocus: l16 = false, ...t14 } = e7, r14 = y(o18.buttonRef, a15, ye()), R7 = Fe(), c13 = p(), d16 = o4((p8) => {
    switch (p8.key) {
      case o8.Enter:
        p2(p8.currentTarget);
        break;
    ...
    if (r4(p8.currentTarget)) return p8.preventDefault();
...
function At2(e7, a15) {
  ...
  l16 && (T12 = true);
  let t14 = W3("Listbox.Options"), r14 = $2("Listbox.Options"), R7 = n8(t14.optionsRef), c13 = u13(), d16 = (() => c13 !== null ? (c13 & d9.Open) === d9.Open : t14.listboxState === 0)();
  m6(t14.buttonRef, r14.closeListbox, d16), u11(R7, t14.__demoMode ? false : O3 && t14.listboxState === 0), T6({ allowed: o4(() => [t14.buttonRef.current, t14.optionsRef.current]) }, t14.__demoMode ? false : O3 && t14.listboxState === 0);
  let E11 = (0, import_react96.useRef)(null);
  (0, import_react96.useEffect)(() => {
    var P7;
    if (!((P7 = l16 == null ? void 0 : l16.to) != null && P7.includes("selection"))) return;
    if (!d16) {
      E11.current = null;
      return;
    }
    let s16 = Array.from(t14.listRef.current.values());
    E11.current = s16.findIndex((C7) => (C7 == null ? void 0 : C7.dataset.selected) === ""), E11.current === -1 && (E11.current = s16.findIndex((C7) => (C7 == null ? void 0 : C7.dataset.disabled) === void 0), r14.goToOption(c6.First));
  }, [d16, t14.listRef]);
  let w10 = p7(t14.buttonRef, t14.listboxState !== 0) ? false : d16, _6 = (() => {
    if (l16 == null) return;
    if (t14.listRef.current.size <= 0) return { ...l16, inner: void 0 };
    let s16 = Array.from(t14.listRef.current.values());
  ...
  let x6 = o4((s16) => {
    switch (M7.dispose(), s16.key) {
      case o8.Space:
        if (t14.searchQuery !== "") return s16.preventDefault(), s16.stopPropagation(), r14.search(s16.key);
      case o8.Enter:
        ...
        t14.mode === 0 && (r14.closeListbox(), o2().nextFrame(() => {
          var P7;
      ...
      case o8.Escape:
        return s16.preventDefault(), s16.stopPropagation(), r14.closeListbox(), B3.nextFrame(() => {
          var P7;
          return (P7 = t14.buttonRef.current) == null ? void 0 : P7.focus({ preventScroll: true });
        });
      case o8.Tab:
        ...
        break;
      default:
        s16.key.length === 1 && (r14.search(s16.key), M7.setTimeout(() => r14.clearSearch(), 350));
        break;
    }
  }), A7 = i11(() => {
    var s16;
...
function ht2(e7, a15) {
  ...
  let w10 = o4((x6) => {
    ...
    if (u17) return t14.goToOption(c6.Nothing);
    t14.goToOption(c6.Specific, n13);
  }), g8 = u12(), y9 = o4((x6) => {
    g8.update(x6), !u17 && (r14 || t14.goToOption(c6.Specific, n13, 0));
  }), I5 = o4((x6) => {
    g8.wasMoved(x6) && (u17 || r14 || t14.goToOption(c6.Specific, n13, 0));
  }), v7 = o4((x6) => {
    g8.wasMoved(x6) && (u17 || r14 && t14.goToOption(c6.Nothing));
  }), B3 = (0, import_react96.useMemo)(() => ({ active: r14, focus: r14, selected: R7, disabled: u17, selectedOption: R7 && i13 }), [r14, R7, u17, i13]), M7 = i13 ? {} : { id: n13, ref: U5, role: "option", tabIndex: u17 === true ? void 0 : -1, "aria-disabled": u17 === true ? true : void 0, "aria-selected": R7, disabled: void 0, onClick: w10, onFocus: _6, onPointerEnter: y9, onMouseEnter: y9, onPointerMove: I5, onMouseMove: I5, onPointerLeave: v7, onMouseLeave: v7 };
...
function j9(e7, a15 = (r14) => r14) {
  let r14 = e7.activeItemIndex !== null ? e7.items[e7.activeItemIndex] : null, s16 = _2(a15(e7.items.slice()), (p8) => p8.dataRef.current.domRef.current), o18 = r14 ? s16.indexOf(r14) : null;
...
var ke3 = { [1](e7) {
  ...
  if (a15.focus === c6.Nothing) return { ...r14, activeItemIndex: null };
  if (a15.focus === c6.Specific) return { ...r14, activeItemIndex: e7.items.findIndex((l16) => l16.id === a15.id) };
  if (a15.focus === c6.Previous) {
    ...
    if (l16 !== null) {
      ...
      if (c13 !== null) {
        ...
        if (((d16 = g8.current) == null ? void 0 : d16.previousElementSibling) === m13.current || ((n13 = m13.current) == null ? void 0 : n13.previousElementSibling) === null) return { ...r14, activeItemIndex: c13 };
      }
    }
  } else if (a15.focus === c6.Next) {
    let l16 = e7.activeItemIndex;
    if (l16 !== null) {
      ...
      if (c13 !== null) {
        let m13 = e7.items[c13].dataRef.current.domRef;
        if (((u17 = g8.current) == null ? void 0 : u17.nextElementSibling) === m13.current || ((t14 = m13.current) == null ? void 0 : t14.nextElementSibling) === null) return { ...r14, activeItemIndex: c13 };
      }
    }
  }
  ...
  return { ...r14, ...s16, activeItemIndex: o18 };
}, [3]: (e7, a15) => {
  ...
  let r14 = j9(e7, (s16) => [...s16, { id: a15.id, dataRef: a15.dataRef }]);
  return { ...e7, ...r14 };
}, [6]: (e7, a15) => {
  let r14 = j9(e7, (s16) => {
...
function We2(e7, a15) {
  let { __demoMode: r14 = false, ...s16 } = e7, o18 = (0, import_react97.useReducer)(we2, { __demoMode: r14, menuState: r14 ? 0 : 1, buttonRef: (0, import_react97.createRef)(), itemsRef: (0, import_react97.createRef)(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: p8, itemsRef: d16, buttonRef: n13 }, u17] = o18, t14 = y(a15);
  w6([n13, d16], (m13, E11) => {
    var I5;
...
function Qe(e7, a15) {
  var D9;
  let r14 = (0, import_react46.useId)(), { id: s16 = `headlessui-menu-button-${r14}`, disabled: o18 = false, autoFocus: p8 = false, ...d16 } = e7, [n13, u17] = w8("Menu.Button"), t14 = Fe(), l16 = y(n13.buttonRef, a15, ye()), g8 = p(), c13 = o4((f20) => {
    switch (f20.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
    ...
    if (r4(f20.currentTarget)) return f20.preventDefault();
...
function Xe2(e7, a15) {
  var h7, M7;
  let r14 = (0, import_react46.useId)(), { id: s16 = `headlessui-menu-items-${r14}`, anchor: o18, portal: p8 = false, modal: d16 = true, ...n13 } = e7, u17 = xe(o18), [t14, l16] = w8("Menu.Items"), [g8, c13] = Re2(u17), m13 = be(), E11 = y(t14.itemsRef, a15, u17 ? g8 : null), I5 = n8(t14.itemsRef);
  u17 && (p8 = true);
  ...
  let C7 = o4((i13) => {
    ...
    switch (P7.dispose(), i13.key) {
      case o8.Space:
        if (t14.searchQuery !== "") return i13.preventDefault(), i13.stopPropagation(), l16({ type: 3, value: i13.key });
      case o8.Enter:
...
function qe2(e7, a15) {
  let r14 = (0, import_react46.useId)(), { id: s16 = `headlessui-menu-item-${r14}`, disabled: o18 = false, ...p8 } = e7, [d16, n13] = w8("Menu.Item"), u17 = d16.activeItemIndex !== null ? d16.items[d16.activeItemIndex].id === s16 : false, t14 = (0, import_react97.useRef)(null), l16 = y(a15, t14);
  n(() => {
    if (d16.__demoMode || d16.menuState !== 0 || !u17 || d16.activationTrigger === 0) return;
    let M7 = o2();
  ...
  let m13 = o4(() => {
    ...
    if (o18) return M7.preventDefault();
    n13({ type: 1 }), G3(d16.buttonRef.current);
  }), I5 = o4(() => {
    if (o18) return n13({ type: 2, focus: c6.Nothing });
...
function Ye2(e7, a15) {
  let [r14, s16] = z();
  return import_react97.default.createElement(s16, null, H({ ourProps: { ref: a15, "aria-labelledby": r14, role: "group" }, theirProps: e7, slot: {}, defaultTag: ze, name: "Menu.Section" }));
}
var Ze = "header";
function et(e7, a15) {
  let r14 = (0, import_react46.useId)(), { id: s16 = `headlessui-menu-heading-${r14}`, ...o18 } = e7, p8 = P4();
...
function rt2(t14, a15) {
  ...
  let { __demoMode: u17 = false, ...C7 } = t14, T12 = (0, import_react98.useRef)(null), S8 = y(a15, T3((o18) => {
    ...
    if (!e7 || !v7) return false;
    for (let b7 of document.querySelectorAll("body > *")) if (Number(b7 == null ? void 0 : b7.contains(e7)) ^ Number(b7 == null ? void 0 : b7.contains(v7))) return true;
    let o18 = b2(), p8 = o18.indexOf(e7), B3 = (p8 + o18.length - 1) % o18.length, r14 = (p8 + 1) % o18.length, d16 = o18[B3], A7 = o18[r14];
  ...
  E5(y9 == null ? void 0 : y9.defaultView, "focus", (o18) => {
    var p8, B3, r14, d16, A7, b7;
    o18.target !== window && o18.target instanceof HTMLElement && f20 === 0 && (L9() || e7 && v7 && (H10.contains(o18.target) || (B3 = (p8 = m13.current) == null ? void 0 : p8.contains) != null && B3.call(p8, o18.target) || (d16 = (r14 = j11.current) == null ? void 0 : r14.contains) != null && d16.call(r14, o18.target) || (b7 = (A7 = n13.current) == null ? void 0 : A7.contains) != null && b7.call(A7, o18.target) || s16({ type: 1 })));
...
function lt2(t14, a15) {
  ...
  (0, import_react98.useEffect)(() => {
    if (!n13) return f20({ type: 3, buttonId: C7 }), () => {
      f20({ type: 3, buttonId: null });
    };
  }, [n13, C7, f20]);
  let [s16] = (0, import_react98.useState)(() => Symbol()), y9 = y(P7, a15, ye(), n13 ? null : (r14) => {
    if (r14) l16.buttons.current.push(s16);
    else {
      let d16 = l16.buttons.current.indexOf(s16);
      d16 !== -1 && l16.buttons.current.splice(d16, 1);
    }
    l16.buttons.current.length > 1 && console.warn("You are already using a <Popover.Button /> but only 1 <Popover.Button /> is supported."), r14 && f20({ type: 2, button: r14 });
  }), _6 = y(P7, a15), x6 = n8(P7), h7 = o4((r14) => {
    var d16, A7, b7;
    if (n13) {
      ...
      switch (r14.key) {
        case o8.Space:
        case o8.Enter:
          r14.preventDefault(), (A7 = (d16 = r14.target).click) == null || A7.call(d16), f20({ type: 1 }), (b7 = l16.button) == null || b7.focus();
          break;
      }
    } else switch (r14.key) {
      case o8.Space:
      case o8.Enter:
        r14.preventDefault(), r14.stopPropagation(), l16.popoverState === 1 && (m13 == null || m13(l16.buttonId)), f20({ type: 0 });
        break;
      case o8.Escape:
        if (l16.popoverState !== 0) return m13 == null ? void 0 : m13(l16.buttonId);
        if (!P7.current || x6 != null && x6.activeElement && !P7.current.contains(x6.activeElement)) return;
        r14.preventDefault(), r14.stopPropagation(), f20({ type: 1 });
        break;
    }
  }), F6 = o4((r14) => {
    n13 || r14.key === o8.Space && r14.preventDefault();
  }), O3 = o4((r14) => {
    var d16, A7;
    r4(r14.currentTarget) || T12 || (n13 ? (f20({ type: 1 }), (d16 = l16.button) == null || d16.focus()) : (r14.preventDefault(), r14.stopPropagation(), l16.popoverState === 1 && (m13 == null || m13(l16.buttonId)), f20({ type: 0 }), (A7 = l16.button) == null || A7.focus()));
  }), D9 = o4((r14) => {
    r14.preventDefault(), r14.stopPropagation();
    ...
    if (!r14) return;
    function d16() {
      u2(p8.current, { [s11.Forwards]: () => P5(r14, F.First), [s11.Backwards]: () => P5(r14, F.Last) }) === T7.Error && P5(b2().filter((b7) => b7.dataset.headlessuiFocusGuard !== "true"), u2(p8.current, { [s11.Forwards]: F.Next, [s11.Backwards]: F.Previous }), { relativeTo: l16.button });
    }
    d16();
  });
...
function st2(t14, a15) {
  let u17 = (0, import_react46.useId)(), { id: C7 = `headlessui-popover-overlay-${u17}`, ...T12 } = t14, [{ popoverState: S8 }, i13] = ne("Popover.Overlay"), l16 = y(a15), f20 = u13(), e7 = (() => f20 !== null ? (f20 & d9.Open) === d9.Open : S8 === 0)(), P7 = o4((m13) => {
    if (r4(m13.currentTarget)) return m13.preventDefault();
    i13({ type: 1 });
...
function ft(t14, a15) {
  ...
  let K4 = o4((c13) => {
    ...
    switch (c13.key) {
      case o8.Escape:
        if (e7.popoverState !== 0 || !n13.current || F6 != null && F6.activeElement && !n13.current.contains(F6.activeElement)) return;
  ...
  (0, import_react98.useEffect)(() => {
    ...
    if (e7.__demoMode || !T12 || e7.popoverState !== 0 || !n13.current) return;
  ...
  let $5 = (0, import_react98.useMemo)(() => ({ open: e7.popoverState === 0, close: v7 }), [e7, v7]), H10 = D(s16 ? x6() : {}, { ref: h7, id: C7, onKeyDown: K4, onBlur: T12 && e7.popoverState === 0 ? (c13) => {
    var o18, p8, B3, r14, d16;
    let E11 = c13.relatedTarget;
    E11 && n13.current && ((o18 = n13.current) != null && o18.contains(E11) || (P7({ type: 1 }), ((B3 = (p8 = e7.beforePanelSentinel.current) == null ? void 0 : p8.contains) != null && B3.call(p8, E11) || (d16 = (r14 = e7.afterPanelSentinel.current) == null ? void 0 : r14.contains) != null && d16.call(r14, E11)) && E11.focus({ preventScroll: true })));
    ...
    function E11() {
      u2(I5.current, { [s11.Forwards]: () => {
        ...
        for (let b7 of d16.slice()) if (b7.dataset.headlessuiFocusGuard === "true" || (A7 = e7.panel) != null && A7.contains(b7)) {
...
function dt(t14, a15) {
  let u17 = (0, import_react98.useRef)(null), C7 = y(u17, a15), [T12, S8] = (0, import_react98.useState)([]), i13 = y6(), l16 = o4((n13) => {
    ...
    for (let s16 of T12) s16.buttonId.current !== n13 && s16.close();
...
function Ue2(o18, t14) {
  let e7 = (0, import_react46.useId)(), a15 = a3(), { id: O3 = `headlessui-radiogroup-${e7}`, value: m13, form: P7, name: i13, onChange: f20, by: c13, disabled: p8 = a15 || false, defaultValue: I5, ...y9 } = o18, T12 = u9(c13), [v7, C7] = (0, import_react99.useReducer)(Fe2, { options: [] }), n13 = v7.options, [U5, h7] = z(), [D9, L9] = U2(), A7 = (0, import_react99.useRef)(null), M7 = y(A7, t14), l16 = l2(I5), [s16, _6] = T(m13, f20, l16), R7 = (0, import_react99.useMemo)(() => n13.find((r14) => !r14.propsRef.current.disabled), [n13]), b7 = (0, import_react99.useMemo)(() => n13.some((r14) => T12(r14.propsRef.current.value, s16)), [n13, s16]), d16 = o4((r14) => {
    var u17;
    if (p8 || T12(r14, s16)) return false;
    let k5 = (u17 = n13.find((H10) => T12(H10.propsRef.current.value, r14))) == null ? void 0 : u17.propsRef.current;
    return k5 != null && k5.disabled ? false : (_6 == null || _6(r14), true);
  }), de4 = o4((r14) => {
    let k5 = A7.current;
    if (!k5) return;
    ...
    switch (r14.key) {
      case o8.Enter:
        p2(r14.currentTarget);
        break;
      case o8.ArrowLeft:
      case o8.ArrowUp:
        if (r14.preventDefault(), r14.stopPropagation(), P5(H10, F.Previous | F.WrapAround) === T7.Success) {
      ...
      case o8.ArrowRight:
      case o8.ArrowDown:
        if (r14.preventDefault(), r14.stopPropagation(), P5(H10, F.Next | F.WrapAround) === T7.Success) {
          let E11 = n13.find((N5) => N5.element.current === (u17 == null ? void 0 : u17.activeElement));
          E11 && d16(E11.propsRef.current.value);
        }
        break;
...
var H8 = "select";
function B(a15, i13) {
  let p8 = (0, import_react46.useId)(), d16 = u5(), n13 = a3(), { id: c13 = d16 || `headlessui-select-${p8}`, disabled: e7 = n13 || false, invalid: t14 = false, autoFocus: o18 = false, ...f20 } = a15, m13 = I2(), u17 = G(), { isFocusVisible: r14, focusProps: T12 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: o18 }), { isHovered: l16, hoverProps: b7 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e7 }), { pressed: s16, pressProps: y9 } = w({ disabled: e7 }), P7 = D({ ref: i13, id: c13, "aria-labelledby": m13, "aria-describedby": u17, "aria-invalid": t14 ? "" : void 0, disabled: e7 || void 0, autoFocus: o18 }, T12, b7, y9), S8 = (0, import_react100.useMemo)(() => ({ disabled: e7, invalid: t14, hover: l16, focus: r14, active: s16, autofocus: o18 }), [e7, t14, l16, r14, s16, o18]);
...
function De4(n13, o18) {
  ...
  let p8 = (0, import_react46.useId)(), f20 = u5(), b7 = a3(), { id: h7 = f20 || `headlessui-switch-${p8}`, disabled: t14 = b7 || false, checked: c13, defaultChecked: T12, onChange: y9, name: a15, value: u17, form: F6, autoFocus: d16 = false, ...k5 } = n13, w10 = (0, import_react101.useContext)(S7), _6 = (0, import_react101.useRef)(null), H10 = y(_6, o18, w10 === null ? null : w10.setSwitch), l16 = l2(T12), [s16, r14] = T(c13, y9, l16 != null ? l16 : false), M7 = p(), [P7, E11] = (0, import_react101.useState)(false), D9 = o4(() => {
    ...
    if (l16 !== void 0) return r14 == null ? void 0 : r14(l16);
  }, [r14, l16]);
...
function b6({ onFocus: n13 }) {
  let [r14, o18] = (0, import_react102.useState)(true), u17 = f17();
  return r14 ? import_react102.default.createElement(T2, { as: "button", type: "button", features: s4.Focusable, onFocus: (a15) => {
    a15.preventDefault();
    let e7, i13 = 50;
    function t14() {
      if (i13-- <= 0) {
...
function C5({ children: n13 }) {
  let t14 = r13.useRef(a14());
  return r13.createElement(s15.Provider, { value: t14 }, n13);
}
function d15(n13) {
  let t14 = r13.useContext(s15);
  if (!t14) throw new Error("You must wrap your component in a <StableCollection>");
  let e7 = f18(), [l16, o18] = t14.current.get(n13, e7);
  return r13.useEffect(() => o18, []), l16;
}
function f18() {
  var l16, o18, i13;
  let n13 = (i13 = (o18 = (l16 = r13.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) == null ? void 0 : l16.ReactCurrentOwner) == null ? void 0 : o18.current) != null ? i13 : null;
  if (!n13) return Symbol();
  let t14 = [], e7 = n13;
  for (; e7; ) t14.push(e7.index), e7 = e7.return;
  return "$." + t14.join(".");
}
...
function Q5(e7) {
  let r14 = (0, import_react103.useContext)(V5);
  if (r14 === null) {
    let t14 = new Error(`<${e7} /> is missing a parent <Tab.Group /> component.`);
...
function Se4(e7, r14) {
  ...
  let c13 = u17 !== null, T12 = s3({ isControlled: c13 }), d16 = y(r14), [i13, s16] = (0, import_react103.useReducer)(_e2, { info: T12, selectedIndex: u17 != null ? u17 : t14, tabs: [], panels: [] }), F6 = (0, import_react103.useMemo)(() => ({ selectedIndex: i13.selectedIndex }), [i13.selectedIndex]), M7 = s3(n13 || (() => {
  ...
  n(() => {
    ...
    if (R7.current === void 0 || i13.tabs.length <= 0) return;
  ...
  return import_react103.default.createElement(C5, null, import_react103.default.createElement(V5.Provider, { value: J6 }, import_react103.default.createElement(z5.Provider, { value: m13 }, m13.tabs.length <= 0 && import_react103.default.createElement(b6, { onFocus: () => {
    var p8, h7;
    for (let L9 of b7.current) if (((p8 = L9.current) == null ? void 0 : p8.tabIndex) === 0) return (h7 = L9.current) == null || h7.focus(), true;
    return false;
  } }), H({ ourProps: k5, theirProps: _6, slot: F6, defaultTag: De5, name: "Tabs" }))));
}
var Fe3 = "div";
function Ie2(e7, r14) {
  let { orientation: t14, selectedIndex: o18 } = C6("Tab.List"), a15 = y(r14), n13 = (0, import_react103.useMemo)(() => ({ selectedIndex: o18 }), [o18]);
  return H({ ourProps: { ref: a15, role: "tablist", "aria-orientation": t14 }, theirProps: e7, slot: n13, defaultTag: Fe3, name: "Tabs.List" });
}
var he2 = "button";
function ve4(e7, r14) {
  var Y4, Z7;
  let t14 = (0, import_react46.useId)(), { id: o18 = `headlessui-tabs-tab-${t14}`, disabled: a15 = false, autoFocus: n13 = false, ...u17 } = e7, { orientation: _6, activation: x6, selectedIndex: f20, tabs: c13, panels: T12 } = C6("Tab"), d16 = Q5("Tab"), i13 = C6("Tab"), s16 = (0, import_react103.useRef)(null), F6 = y(s16, r14);
  ...
  let m13 = b7 === f20, E11 = o4((l16) => {
    ...
    } })) === T7.Success) return l16.preventDefault();
...
var Ce3 = "div";
function Me2(e7, r14) {
  let { selectedIndex: t14 } = C6("Tab.Panels"), o18 = y(r14), a15 = (0, import_react103.useMemo)(() => ({ selectedIndex: t14 }), [t14]);
...
function He4(e7, r14) {
  var E11, I5, g8, R7;
  let t14 = (0, import_react46.useId)(), { id: o18 = `headlessui-tabs-panel-${t14}`, tabIndex: a15 = 0, ...n13 } = e7, { selectedIndex: u17, tabs: _6, panels: x6 } = C6("Tab.Panel"), f20 = Q5("Tab.Panel"), c13 = (0, import_react103.useRef)(null), T12 = y(c13, r14);
...
var L7 = "textarea";
function H9(s16, l16) {
  let i13 = (0, import_react46.useId)(), p8 = u5(), d16 = a3(), { id: n13 = p8 || `headlessui-textarea-${i13}`, disabled: e7 = d16 || false, autoFocus: r14 = false, invalid: a15 = false, ...T12 } = s16, f20 = I2(), m13 = G(), { isFocused: o18, focusProps: u17 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: r14 }), { isHovered: t14, hoverProps: b7 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e7 }), y9 = D({ ref: l16, id: n13, "aria-labelledby": f20, "aria-describedby": m13, "aria-invalid": a15 ? "" : void 0, disabled: e7 || void 0, autoFocus: r14 }, u17, b7), x6 = (0, import_react104.useMemo)(() => ({ disabled: e7, invalid: a15, hover: t14, focus: o18, autofocus: r14 }), [e7, a15, t14, o18, r14]);
...
function c12(a15 = 0) {
  let [l16, r14] = (0, import_react105.useState)(a15), t14 = f17(), o18 = (0, import_react105.useCallback)((e7) => {
    t14.current && r14((u17) => u17 | e7);
  }, [l16, t14]), m13 = (0, import_react105.useCallback)((e7) => !!(l16 & e7), [l16]), s16 = (0, import_react105.useCallback)((e7) => {
    t14.current && r14((u17) => u17 & ~e7);
  }, [r14, t14]), g8 = (0, import_react105.useCallback)((e7) => {
    t14.current && r14((u17) => u17 ^ e7);
  }, [r14]);
...
function l15(r14) {
  let e7 = { called: false };
  return (...t14) => {
    if (!e7.called) return e7.called = true, r14(...t14);
  };
}

// node_modules/@headlessui/react/dist/components/transition/utils/transition.js
function v5(t14, ...r14) {
  t14 && r14.length > 0 && t14.classList.add(...r14);
}
function T10(t14, ...r14) {
  t14 && r14.length > 0 && t14.classList.remove(...r14);
}
function L8(t14, r14) {
  let n13 = l15(r14), e7 = o2();
  if (!t14) return e7.dispose;
...
function F5(t14, { direction: r14, done: n13, classes: e7, inFlight: o18 }) {
  let m13 = o2(), s16 = n13 !== void 0 ? l15(n13) : () => {
  };
  r14 === "enter" && (t14.removeAttribute("hidden"), t14.style.display = "");
  let u17 = u2(r14, { enter: () => e7.enter, leave: () => e7.leave }), p8 = u2(r14, { enter: () => e7.enterTo, leave: () => e7.leaveTo }), a15 = u2(r14, { enter: () => e7.enterFrom, leave: () => e7.leaveFrom });
...
function M6(t14, { inFlight: r14, prepare: n13 }) {
...
function v6({ container: i13, direction: e7, classes: s16, onStart: o18, onStop: t14 }) {
  let a15 = f17(), r14 = p(), l16 = (0, import_react106.useRef)(false);
  n(() => {
    if (e7 === "idle" || !a15.current) return;
    o18.current(e7);
    let n13 = i13.current;
    return n13 ? r14.add(F5(n13, { direction: e7, classes: s16.current, inFlight: l16, done() {
      t14.current(e7);
    } })) : t14.current(e7), r14.dispose;
  }, [e7]);
}
...
function Fe4() {
  ...
  if (t14 === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return t14;
}
function _e3() {
...
function fe3(t14, n13) {
  let r14 = s3(t14), a15 = (0, import_react107.useRef)([]), H10 = f17(), L9 = p(), d16 = o4((i13, e7 = M.Hidden) => {
    ...
    o18 !== -1 && (u2(e7, { [M.Unmount]() {
      ...
      var s16;
      !q5(a15) && H10.current && ((s16 = r14.current) == null || s16.call(r14));
    }));
  }), F6 = o4((i13) => {
...
function De6(t14, n13) {
  ...
  let _6 = s3({ base: y8(i13.className), enter: y8(d16), enterFrom: y8(F6), enterTo: y8(R7), entered: y8(f20), leave: y8(C7), leaveFrom: y8(m13), leaveTo: y8(h7) }), U5 = s3({ beforeEnter: r14, afterEnter: a15, beforeLeave: H10, afterLeave: L9 }), X3 = l10();
  n(() => {
    if (o18 && X3 && P7 === "visible" && e7.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e7, P7, X3, o18]);
...
function He5(t14, n13) {
  let { show: r14, appear: a15 = false, unmount: H10 = true, ...L9 } = t14, d16 = (0, import_react107.useRef)(null), F6 = de3(t14), R7 = y(...F6 ? [d16, n13] : n13 === null ? [] : [n13]);
  l10();
  let f20 = u13();
  if (r14 === void 0 && f20 !== null && (r14 = (f20 & d9.Open) === d9.Open), r14 === void 0) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
  let [C7, m13] = (0, import_react107.useState)(r14 ? "visible" : "hidden"), h7 = fe3(() => {
    r14 || m13("hidden");
  }), [i13, e7] = (0, import_react107.useState)(true), o18 = (0, import_react107.useRef)([r14]);
  n(() => {
    i13 !== false && o18.current[o18.current.length - 1] !== r14 && (o18.current.push(r14), e7(false));
  }, [o18, r14]);
  let s16 = (0, import_react107.useMemo)(() => ({ show: r14, appear: a15, initial: i13 }), [r14, a15, i13]);
  m6(d16, () => m13("hidden")), n(() => {
    r14 ? m13("visible") : !q5(h7) && d16.current !== null && m13("hidden");
  }, [r14, h7]);
...
function Le5(t14, n13) {
  let r14 = (0, import_react107.useContext)(W5) !== null, a15 = u13() !== null;
  return import_react107.default.createElement(import_react107.default.Fragment, null, !r14 && a15 ? import_react107.default.createElement(Z6, { ref: n13, ...t14 }) : import_react107.default.createElement(pe5, { ref: n13, ...t14 }));
}
var Z6 = I(He5);
var pe5 = I(De6);
var Ae3 = I(Le5);
