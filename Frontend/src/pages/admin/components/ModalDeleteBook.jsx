...
export const ModalDeleteBook = ({ onRemoveBook }) => {
                        ...
                        <div className="relative w-full my-6 mx-auto max-w-sm"> {/* Cambiado a max-w-sm y w-full */}
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none overflow-y-auto"> {/* Añadido overflow-y-auto */}
                                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                                    <h3 className="text-3xl font-semibold">Eliminar Libro</h3>
                                    <button
                                        className="p-1 ml-auto bg-transparent border-0 text-black float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                                        onClick={closeModalDeleteBook}
                                    >
                                ...
                                <div className="relative p-6 flex-auto">
                                    <div className="p-4 md:p-5 text-center">
                                        ...
                                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Esta seguro de eliminar el libro <b>{dataBook.titulo}?</b></h3>
                                    </div>
                                </div>
